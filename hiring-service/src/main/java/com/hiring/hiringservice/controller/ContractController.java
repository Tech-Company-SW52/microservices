...
public class ContractController {
    ...
    public ContractController(ContractService contractService,
                              ...
                              StatusService statusContractService, NotificationService notificationService) {
    ...
    public ResponseEntity<Contract> updateContractNotificationPatch(@PathVariable("idContract") Long idContract) {
        try {
            ...
            if (contract.isPresent()) {
                ...
                if (contractUpdate.getNotifications().getId() == 0) {
        ...
        try {
            ...
            if (contracts.size() > 0) {
                contracts.forEach(contract -> {
                    contract.setNotifications(notification.get());
                    try {
